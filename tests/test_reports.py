...
def sample_transactions():
    data = {
        'Дата платежа': [
            '01.01.2023', '15.01.2023', '01.02.2023', '15.02.2023',
            '01.03.2023', '15.03.2023', '01.04.2023', '15.04.2023',
            '01.05.2023', '15.05.2023', '01.06.2023', '15.06.2023',
            '01.12.2024', '15.12.2024', '01.01.2025', '15.01.2025',
...
def test_custom_date_february(sample_transactions):
    ...
    expected = pd.Series(
        [600],
        index=pd.Index(['food'], name='Категория'),
...
def test_no_results(sample_transactions):
    ...
    expected = pd.Series(
        [],
        index=pd.Index([], dtype='object', name='Категория'),
        name='Сумма операции с округлением',
        dtype='int64'
    )
    pd.testing.assert_series_equal(result, expected)